...
public class RulesFactory {
  ...
  public List<Rule> getDefaultLintingRules() {
    return List.of(
        ...
        new Rule(
            "identifier-style", "Identificadores con estilo (camelCase o snake_case)", false, null),
        new Rule("println-restriction", "println solo admite literal o identificador", true, null),
        new Rule("string-number-concat", "Concat de string con number con '+'", true, null),
        new Rule("read-input-prompt", "readInput con prompt string o identificador", true, null));
  }
}
